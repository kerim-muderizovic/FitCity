...
public interface IMembershipService
{
    ...
    Task<MembershipRequestDto?> DecideRequestAsync(Guid requestId, bool approve, string? rejectionReason, Guid adminUserId, string adminRole, CancellationToken cancellationToken);
