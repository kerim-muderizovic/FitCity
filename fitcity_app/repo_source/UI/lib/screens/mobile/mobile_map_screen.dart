...
class _MobileMapScreenState extends State<MobileMapScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: buildMobileAppBar(context, title: context.l10n.mapTitle),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Text(context.l10n.mapTitle, style: Theme.of(context).textTheme.titleMedium),
                    ],
                  ),
            ...
            Align(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    AccentButton(
                      label: context.l10n.mapOpenGym(selected.name),
                      onPressed: () {
