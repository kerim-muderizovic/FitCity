...
class AdminSettings {
  final bool allowGymRegistrations;
  final bool allowUserRegistration;
  final bool allowTrainerCreation;

  AdminSettings({
    required this.allowGymRegistrations,
    required this.allowUserRegistration,
    required this.allowTrainerCreation,
  });

  factory AdminSettings.fromJson(Map<String, dynamic> json) {
    return AdminSettings(
      allowGymRegistrations: readJsonValue<bool>(json, 'allowGymRegistrations') ?? true,
      allowUserRegistration: readJsonValue<bool>(json, 'allowUserRegistration') ?? true,
      allowTrainerCreation: readJsonValue<bool>(json, 'allowTrainerCreation') ?? true,
    );
  }

  Map<String, dynamic> toJson() => {
        'allowGymRegistrations': allowGymRegistrations,
        'allowUserRegistration': allowUserRegistration,
        'allowTrainerCreation': allowTrainerCreation,
      };
}
...
class MembershipRequest {
  ...
  factory MembershipRequest.fromJson(Map<String, dynamic> json) {
    return MembershipRequest(
      ...
      rejectedAtUtc: readJsonDate(json, 'rejectedAtUtc'),
      rejectedByUserId: readJsonValue<String>(json, 'rejectedByUserId'),
      rejectionReason: readJsonValue<String>(json, 'rejectionReason'),
...
class QrScanResult {
  ...
  factory QrScanResult.fromJson(Map<String, dynamic> json) {
    return QrScanResult(
      ...
      reason: readJsonValue<String>(json, 'reason') ?? '',
      entered: readJsonValue<bool>(json, 'entered') ?? false,
...
class GymQr {
  ...
  factory GymQr.fromJson(Map<String, dynamic> json) {
    return GymQr(
      gymId: readJsonValue<String>(json, 'gymId') ?? '',
      gymName: readJsonValue<String>(json, 'gymName') ?? '',
      payload: readJsonValue<String>(json, 'payload') ?? '',
    );
  }
}
...
class StripeCheckoutResponse {
  ...
  StripeCheckoutResponse({required this.url});

  factory StripeCheckoutResponse.fromJson(Map<String, dynamic> json) {
    return StripeCheckoutResponse(
      url: readJsonValue<String>(json, 'url') ?? '',
    );
  }
}
...
class AdminPayment {
  ...
  factory AdminPayment.fromJson(Map<String, dynamic> json) {
    return AdminPayment(
      id: readJsonValue<String>(json, 'id') ?? '',
      amount: (readJsonValue<num>(json, 'amount') ?? 0).toDouble(),
      method: readJsonValue<String>(json, 'method') ?? '',
      paidAtUtc: readJsonDate(json, 'paidAtUtc'),
      type: readJsonValue<String>(json, 'type') ?? '',
      status: readJsonValue<String>(json, 'status') ?? '',
      memberId: readJsonValue<String>(json, 'memberId'),
      memberName: readJsonValue<String>(json, 'memberName'),
      gymId: readJsonValue<String>(json, 'gymId'),
      gymName: readJsonValue<String>(json, 'gymName'),
      referenceId: readJsonValue<String>(json, 'referenceId'),
    );
  }
}
