...
public interface ITrainerService
{
    ...
    Task<TrainerDto> CreateForGymAdminAsync(Guid adminUserId, GymAdminTrainerCreateRequest request, CancellationToken cancellationToken);
    ...
    Task<TrainerDto?> GetMyProfileAsync(Guid userId, CancellationToken cancellationToken);
