...
public class AuthService : IAuthService
{
    ...
    public async Task<AuthResponse> RegisterAsync(RegisterRequest request, CancellationToken cancellationToken)
    {
        ...
        {
            throw new UserException("User registration is currently disabled.");
        }
        ...
        await SendWelcomeEmailSafeAsync(user, cancellationToken);
    ...
    public async Task<AuthResponse> LoginAdminAsync(LoginRequest request, CancellationToken cancellationToken)
    {
        var user = await ValidateCredentialsAsync(request, cancellationToken);
        if (user.Role is not (UserRole.CentralAdministrator or UserRole.GymAdministrator))
        {
            throw new InvalidOperationException("Only administrator accounts can sign in here.");
        }
    ...
    private async Task SendWelcomeEmailSafeAsync(User user, CancellationToken cancellationToken)
    {
        try
        {
