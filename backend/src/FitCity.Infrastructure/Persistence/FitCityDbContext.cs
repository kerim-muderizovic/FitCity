...
public class FitCityDbContext : DbContext
{
    ...
    public DbSet<GymQrCode> GymQrCodes => Set<GymQrCode>();
    ...
    public DbSet<FitCity.Domain.Entities.AppSettings> AppSettings => Set<FitCity.Domain.Entities.AppSettings>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MembershipRequest>(builder =>
        {
            ...
            builder.Property(m => m.RejectionReason).HasMaxLength(400);
        ...
        modelBuilder.Entity<GymQrCode>(builder =>
        {
            builder.HasKey(q => q.Id);
            builder.Property(q => q.Token).HasMaxLength(128).IsRequired();
            builder.HasIndex(q => q.GymId).IsUnique();
            builder.HasIndex(q => q.Token).IsUnique();
            builder.HasOne(q => q.Gym)
                .WithOne(g => g.QrCode)
        ...
        modelBuilder.Entity<CheckInLog>(builder =>
        {
            ...
            builder.Property(c => c.IsSuccessful).HasDefaultValue(true);
            builder.Property(c => c.QrPayload).HasMaxLength(2048);
        ...
        modelBuilder.Entity<Payment>(builder =>
        {
            ...
            builder.Property(p => p.ProviderEventId).HasMaxLength(200);
        ...
        modelBuilder.Entity<PaymentAudit>(builder =>
        {
            builder.HasKey(p => p.Id);
            builder.Property(p => p.EventType).HasMaxLength(100);
            builder.Property(p => p.Provider).HasMaxLength(50);
            builder.Property(p => p.Amount).HasColumnType("decimal(18,2)");
        ...
        modelBuilder.Entity<FitCity.Domain.Entities.AppSettings>(builder =>
        {
            builder.HasKey(s => s.Id);
            builder.Property(s => s.AllowGymRegistrations).HasDefaultValue(true);
            builder.Property(s => s.AllowUserRegistration).HasDefaultValue(true);
            builder.Property(s => s.AllowTrainerCreation).HasDefaultValue(true);
        });
    ...
    private static void SeedData(ModelBuilder modelBuilder)
    {
        ...
        var plan5 = Guid.Parse("50505050-5050-5050-5050-505050505051");
        var plan6 = Guid.Parse("60606060-6060-6060-6060-606060606062");
        var plan7 = Guid.Parse("70707070-7070-7070-7070-707070707073");
        var plan8 = Guid.Parse("80808080-8080-8080-8080-808080808084");

        var membershipRequest = Guid.Parse("50505050-5050-5050-5050-505050505050");
        var membershipRequest2 = Guid.Parse("50505050-5050-5050-5050-505050505052");
        var membershipRequest3 = Guid.Parse("50505050-5050-5050-5050-505050505053");
        var membershipRequest4 = Guid.Parse("50505050-5050-5050-5050-505050505054");
        var membershipRequest5 = Guid.Parse("50505050-5050-5050-5050-505050505055");
        var membershipRequest6 = Guid.Parse("50505050-5050-5050-5050-505050505056");

        var membership = Guid.Parse("60606060-6060-6060-6060-606060606060");
        var membership2 = Guid.Parse("60606060-6060-6060-6060-606060606061");
        var membership3 = Guid.Parse("60606060-6060-6060-6060-606060606062");
        var membership4 = Guid.Parse("60606060-6060-6060-6060-606060606063");
        ...
        var session3 = Guid.Parse("92929292-9292-9292-9292-929292929291");
        var session4 = Guid.Parse("93939393-9393-9393-9393-939393939392");
        var session5 = Guid.Parse("94949494-9494-9494-9494-949494949493");
        var session6 = Guid.Parse("95959595-9595-9595-9595-959595959594");
        var session7 = Guid.Parse("96969696-9696-9696-9696-969696969595");
        ...
        modelBuilder.Entity<GymTrainer>().HasData(
            new GymTrainer { GymId = gym1, TrainerId = trainer1, AssignedAtUtc = seedNow },
            new GymTrainer { GymId = gym1, TrainerId = trainer2, AssignedAtUtc = seedNow },
            new GymTrainer { GymId = gym2, TrainerId = trainer3, AssignedAtUtc = seedNow },
            new GymTrainer { GymId = gym2, TrainerId = trainer4, AssignedAtUtc = seedNow },
            new GymTrainer { GymId = gym3, TrainerId = trainer5, AssignedAtUtc = seedNow },
            new GymTrainer { GymId = gym4, TrainerId = trainer6, AssignedAtUtc = seedNow },
        ...
        modelBuilder.Entity<GymPlan>().HasData(
            ...
            new GymPlan { Id = plan5, GymId = gymNovoSarajevo, Name = "Monthly", Price = 55.00m, DurationMonths = 1, Description = "Monthly access." },
            new GymPlan { Id = plan6, GymId = gymGrbavica, Name = "Quarterly", Price = 139.00m, DurationMonths = 3, Description = "Three months access." },
            new GymPlan { Id = plan7, GymId = gymBosna, Name = "Annual", Price = 419.00m, DurationMonths = 12, Description = "Annual membership." },
            new GymPlan { Id = plan8, GymId = gymGrada, Name = "Monthly", Price = 45.00m, DurationMonths = 1, Description = "Monthly access." }
        );
        ...
        modelBuilder.Entity<MembershipRequest>().HasData(
            ...
            new MembershipRequest { Id = membershipRequest2, UserId = userMember3, GymId = gym2, GymPlanId = plan2, Status = MembershipRequestStatus.Pending },
            new MembershipRequest { Id = membershipRequest3, UserId = userMember4, GymId = gym4, GymPlanId = plan4, Status = MembershipRequestStatus.Pending },
            new MembershipRequest { Id = membershipRequest4, UserId = userMember1, GymId = gymNovoSarajevo, GymPlanId = plan5, Status = MembershipRequestStatus.Pending },
            new MembershipRequest { Id = membershipRequest5, UserId = userMember2, GymId = gymGrbavica, GymPlanId = plan6, Status = MembershipRequestStatus.Pending },
            new MembershipRequest { Id = membershipRequest6, UserId = userMember5, GymId = gymBosna, GymPlanId = plan7, Status = MembershipRequestStatus.Pending }
        );
        ...
        modelBuilder.Entity<Membership>().HasData(
            ...
            new Membership
            {
                ...
                GymId = gym3,
                GymPlanId = plan3,
                StartDateUtc = seedNow.AddDays(-20),
                EndDateUtc = seedNow.AddMonths(6),
                Status = MembershipStatus.Active
            },
            new Membership
            {
                ...
                GymId = gymGrada,
                GymPlanId = plan8,
                StartDateUtc = seedNow.AddDays(-5),
                EndDateUtc = seedNow.AddMonths(1),
                Status = MembershipStatus.Active
            },
            new Membership
            {
                Id = membership4,
                UserId = userMember5,
                GymId = gymNovoSarajevo,
                GymPlanId = plan5,
                StartDateUtc = seedNow.AddDays(-2),
                EndDateUtc = seedNow.AddMonths(1),
                Status = MembershipStatus.Active
            }
        );
        ...
        modelBuilder.Entity<TrainingSession>().HasData(
            ...
            new TrainingSession { Id = session3, UserId = userMember1, TrainerId = trainer2, GymId = gymNovoSarajevo, StartUtc = seedNow.AddDays(3).Date.AddHours(8), EndUtc = seedNow.AddDays(3).Date.AddHours(9), Status = TrainingSessionStatus.Confirmed },
            new TrainingSession { Id = session4, UserId = userMember2, TrainerId = trainer4, GymId = gymBosna, StartUtc = seedNow.AddDays(3).Date.AddHours(18), EndUtc = seedNow.AddDays(3).Date.AddHours(19), Status = TrainingSessionStatus.Confirmed },
            new TrainingSession { Id = session5, UserId = userMember5, TrainerId = trainer6, GymId = gymGrada, StartUtc = seedNow.AddDays(4).Date.AddHours(7), EndUtc = seedNow.AddDays(4).Date.AddHours(8), Status = TrainingSessionStatus.Confirmed },
            new TrainingSession { Id = session6, UserId = userMember1, TrainerId = trainer3, GymId = gym2, StartUtc = seedNow.AddDays(4).Date.AddHours(12), EndUtc = seedNow.AddDays(4).Date.AddHours(13), Status = TrainingSessionStatus.Confirmed },
            new TrainingSession { Id = session7, UserId = userMember2, TrainerId = trainer6, GymId = gym4, StartUtc = seedNow.AddDays(5).Date.AddHours(9), EndUtc = seedNow.AddDays(5).Date.AddHours(10), Status = TrainingSessionStatus.Confirmed }
        );
        ...
        modelBuilder.Entity<FitCity.Domain.Entities.AppSettings>().HasData(
            new FitCity.Domain.Entities.AppSettings
            {
                Id = FitCity.Domain.Entities.AppSettings.DefaultId,
