...
class _MobileChatScreenState extends State<MobileChatScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: buildMobileAppBar(context, title: 'Chat'),
            ...
            child: Column(
              ...
              children: [
                ...
                if (_loading)
                  ...
                  const Expanded(child: Center(child: Text('No conversations yet.', style: TextStyle(color: AppColors.muted))))
                else
                  Expanded(
  ...
  void _handleIncomingMessage(Map<String, dynamic> payload) {
    ...
    Future<void> _loadPendingPayment() async {
      ...
      try {
        ...
        setState(() => _paymentError = error.toString());
      }
    }
    ...
    Future<void> _payBooking() async {
      ...
      try {
        final updated = await _api.payBooking(booking.id);
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text('Payment details', style: TextStyle(fontWeight: FontWeight.w700)),
                          Text(
                            '${_latestBooking!.trainerName} - ${_latestBooking!.startUtc.toLocal()}',
